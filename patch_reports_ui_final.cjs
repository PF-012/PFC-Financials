                 ...
                 <div className="flex-1 p-6 space-y-4">
                    ...
                    <div className="pt-4 flex justify-between text-sm font-semibold">
                       ...
                       <span className={reportData.grossProfit >= 0 ? "text-gray-900 font-medium" : "text-gray-400 font-medium"}>
                          {reportData.grossProfit > 0 ? "₹ " + reportData.grossProfit.toLocaleString('en-IN', {minimumFractionDigits: 2, maximumFractionDigits: 2}) : "-"}
                       </span>
                    </div>
              ...
              <div className="p-0 flex flex-col">
                 ...
                 <div className="flex-1 p-6 space-y-4">
                    ...
                    <div className="pt-4 flex justify-between text-sm font-semibold">
                       ...
                       <span className={reportData.grossProfit < 0 ? "text-gray-900 font-medium" : "text-gray-400 font-medium"}>
                          {reportData.grossProfit < 0 ? "₹ " + Math.abs(reportData.grossProfit).toLocaleString('en-IN', {minimumFractionDigits: 2, maximumFractionDigits: 2}) : "-"}
                       </span>
                    </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200">
                       <div className="flex justify-between text-sm mb-4 font-semibold text-gray-900">
                          ...
                          <span>{reportData.grossProfit > 0 ? "₹ " + reportData.grossProfit.toLocaleString('en-IN', {minimumFractionDigits: 2, maximumFractionDigits: 2}) : "₹ 0.00"}</span>
                       </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-0 md:border-r border-gray-200 flex flex-col">
                 ...
                 <div className="flex-1 p-6 space-y-4">
                    ...
                    <div className="pt-4 flex justify-between text-sm font-semibold">
                       <span className="text-gray-900">Profit & Loss A/c</span>
              ...
              <div className="p-0 flex flex-col">
                 ...
                 <div className="flex-1 p-6 space-y-4">
                    ...
                    <div className="flex justify-between text-sm cursor-pointer active:bg-gray-200 md:hover:bg-gray-100 -mx-2 px-2 py-1 rounded transition-colors" onClick={() => handleBreakdown('Current Assets', 'ledgers', l => ['Current Assets', 'Sundry Debtors', 'Cash-in-Hand', 'Bank Accounts'].includes(l.group))}>
                       <span className="text-blue-600 font-medium underline underline-offset-2 decoration-blue-300 hover:decoration-blue-600">Current Assets / Sundry Debtors</span>
...
const pnlEnd = code.indexOf("{activeReport === 'balanceSheet' && (");
const bsEnd = code.indexOf("{activeReport === 'trialBalance' && (");

if (pnlStart !== -1 && pnlEnd !== -1 && bsEnd !== -1) {
    code = code.substring(0, pnlStart) + pnlReplacement + "\n      " + bsReplacement + "\n      " + code.substring(bsEnd);
    fs.writeFileSync('src/pages/Reports.tsx', code);
    console.log("Reverted UI to old interface successfully!");
} else {
